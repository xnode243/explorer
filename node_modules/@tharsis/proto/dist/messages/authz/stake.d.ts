...
export declare function createStakeAuthorization(allowAddress: string, denom: string, maxTokens: string, authorizationType: authzStake.cosmos.staking.v1beta1.AuthorizationType): {
